...
function Press() {
  ...
  return (
    <>
      ...
      <section
        ref={ref}
        className={`bg-surface-warm py-16 sm:py-20 lg:py-24 ${
          visible ? "animate-[fadeUp_0.8s_ease-out_both]" : "opacity-0"
        }`}
      >
        <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 lg:gap-8">
            {newsMediaImages.slice(0, 3).map((item, index) => (
              <article
                key={item.id}
                className="group overflow-hidden rounded-2xl border border-border bg-white shadow-sm transition duration-500 hover:-translate-y-1 hover:shadow-md animate-[fadeUp_0.7s_ease-out_both]"
          ...
          <div className="mt-12 rounded-2xl border-b-[3px] border-b-petal bg-gradient-to-br from-deep to-mid p-10 text-center animate-[fadeUp_0.8s_ease-out_both] [animation-delay:0.35s]">
